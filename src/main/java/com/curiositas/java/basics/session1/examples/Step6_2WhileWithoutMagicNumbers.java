...
public class Step6_2WhileWithoutMagicNumbers {
    private final static int maximumTimes = 10; // We will roll dice only 3 times in order not to get tired
    private final static int minimalDiceResult = 1; // It's a minimal possible value of the dice
    private final static int maximumDiceResult = 10; // It's a maximal possible value of the dice
