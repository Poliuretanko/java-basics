...
import com.curiositas.java.basics.session3.examples.polymorphism.Article;
import com.curiositas.java.basics.session3.examples.polymorphism.Book;
import com.curiositas.java.basics.session3.examples.polymorphism.Manuscript;
import com.curiositas.java.basics.session3.examples.polymorphism.Newspaper;
import com.curiositas.java.basics.session3.examples.polymorphism.formatters.CuttingFormatter;
import com.curiositas.java.basics.session3.examples.polymorphism.formatters.Formatter;
import com.curiositas.java.basics.session3.examples.polymorphism.formatters.ReverseFormatter;
import com.curiositas.java.basics.session3.examples.polymorphism.formatters.UpperCaseFormatter;
